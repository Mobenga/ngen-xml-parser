...
import com.mobenga.ngen.xml.parser.*;
import com.mobenga.ngen.xml.util.MappingUtil;

public class EventMapperExample5 implements Mappings {
    ...
    private ElementParserSettings market() {
        ...
        settings.setAttributeMappings(
                ...
                new AttributeMappingExtended<>(Market.class, Market::setName, EventMapperExample5Utils::getMarketNameInclEventName, "name")
        );
